...
def grid_search(good_samples_folder, bad_samples_folder, parameter1, parameter2):
    ...
    np.save('figures/heatmaps/separate_values/heatmap_test_accuracy_%s_%s.npy' %(parameter1, parameter2), all_test_accuracies) 
    np.save('figures/heatmaps/separate_values/heatmap_train_accuracy_%s_%s.npy' %(parameter1, parameter2), all_train_accuracies) 
    np.save('figures/heatmaps/separate_values/heatmap_test_loss_%s_%s.npy' %(parameter1, parameter2), all_test_loss) 
    np.save('figures/heatmaps/separate_values/heatmap_train_loss_%s_%s.npy' %(parameter1, parameter2), all_train_loss) 
    np.save('figures/heatmaps/separate_values/heatmap_recall_%s_%s.npy' %(parameter1, parameter2), all_recall) 
...
if __name__ == '__main__':
    ...
    #model, history, recall = evaluate_CNN_new(X_train, y_train, X_test, y_test, std, save_model='saved_nets/weathernet_TEST.h5', best_params=True)
